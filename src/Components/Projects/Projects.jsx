...
export const Projects=()=>{
     return(
          <div className='Projects' id='Projects'>
               <h1 className='Projects-me'>PROJECTS</h1>
               <div className='Projects-container'>
                    ...
                    <div className='Projects-container-div'>
                         ...
                         <div className='Projects-container-text'>
                              <p>It is a back-end project created by my team at Masai School, here we are using NodeJs, ExpressJs, and MongoDB. I take responsibility of Building Server, Maintain Database and Create APIs.</p>
                    ...
                    <div className='Projects-container-div'>
                         ...
                         <div className='Projects-container-text'>
                              <p>It was a front-end project created by my team at Masai School, It was a team of 4 members, here we are using HTML, CSS, and JavaScript. I take the responsibility for Building the Product Page and Cart Page using API methods.</p>
                              <div className='Projects-container-btns'>
                    ...
                    <div className='Projects-container-div'>
                         ...
                         <div className='Projects-container-text'>
                              <p>It was my Professional Portfolio Project. It was a solo Project of mine, here I am using React and CSS to complete the it. Live site of this project contains my professional details and link to my professional social accounts. </p>
                              <div className='Projects-container-btns'>
